"""生成 sw_charts.html — 申万行业分析报告网页"""
import os

OUTPUT = os.path.join(os.path.dirname(__file__), "sw_charts.html")
...
<div class="chart-title"><span>PE / PB 图表</span><span class="badge">10年数据</span></div>
<div class="chart-body">

<h3 style="text-align:left;padding:8px 0;color:#1a3a5c;font-size:15px;border-bottom:1px solid #eee;">蜡烛图</h3>
...
<div style="margin-top:12px;"><img src="../Chart_PB_Candlestick.png" alt="PB二级蜡烛图" onclick="window.open(this.src)" style="width:100%"></div>
...
<h3 style="text-align:left;padding:16px 0 8px;color:#1a3a5c;font-size:15px;border-bottom:1px solid #eee;">柱线图</h3>
<div><img src="../Chart_PE_L2_BarWithLine.png" alt="PE二级柱线图" onclick="window.open(this.src)" style="width:100%"></div>
<div style="margin-top:12px;"><img src="../Chart_PE_L1_BarWithLine.png" alt="PE一级柱线图" onclick="window.open(this.src)" style="width:100%"></div>
<div style="margin-top:12px;"><img src="../Chart_PB_L2_BarWithLine.png" alt="PB二级柱线图" onclick="window.open(this.src)" style="width:100%"></div>
<div style="margin-top:12px;"><img src="../Chart_PB_L1_BarWithLine.png" alt="PB一级柱线图" onclick="window.open(this.src)" style="width:100%"></div>
...
<h3 style="text-align:left;padding:8px 0;color:#1a3a5c;font-size:15px;border-bottom:1px solid #eee;">申万二级行业估值百分位分布</h3>
<div><img src="../sw2_valuation_chart.png" alt="实盘主动PB/PE估值百分位" onclick="window.open(this.src)" style="width:100%"></div>
...
<a href="../实盘主动_申万二级行业估值.xlsx">实盘主动_申万二级行业估值.xlsx</a>
</div>

</div></div>

<div id="pe_stats" class="chart-card">
<div class="chart-title"><span>PE 行业统计分析</span><span class="badge">Excel</span></div>
<div class="file-list"><a href="../PE_Statistics_by_Sector.xlsx">PE行业统计（含PE/TTM、分位数、均值）</a></div></div>
...
<footer>数据来源：Wind / 申万研究所 | 生成日期：2026-07-24 | 仅供参考</footer>
</body>
</html>'''
